...
@property (nonatomic, strong) PushReceiver* pushReceiver;
...
- (void)applicationDidBecomeActive:(UIApplication *)application {
    ...
    // Register a receiver to handle push notifications
    self.pushReceiver = [[PushReceiver alloc] init];
    [AWSPushManager defaultPushManager].receiver = self.pushReceiver;
}
