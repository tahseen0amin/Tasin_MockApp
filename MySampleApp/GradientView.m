...
//  MDAFS
//
//  Created by Taseen Amin on 18/05/2014.
...
- (void)drawRect:(CGRect)rect
{
    ...
    /*inner glow
    UIColor *innerGlow = [UIColor colorWithWhite:1.0 alpha:0.3];
    UIBezierPath *innerGlowRect = [UIBezierPath  bezierPathWithRoundedRect: rect cornerRadius: 12.0];
    [innerGlow setFill];
